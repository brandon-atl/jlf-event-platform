...
REGISTRATIONS = {
    ...
    "e2": [
        ...
        ("devon",   "complete", 12500, "tipi_twin",  None, None, 27),
        ...
        ("indigo",  "complete", 12500, "tipi_twin",  None, None, 23),
        ...
        ("sol",     "pending_payment", 0, "tipi_twin",None,None, 4),
    ],
    ...
    # Accommodation (complete only): bell_tent(4), tipi_twin(2), self_camping(3), none(1 day-visitor) = 10 + willow "none" = 11
    "e4": [
        ("mara",    "complete",        5000, "bell_tent",   None,          1, 14),  # checked in 1h after start
        ("devon",   "complete",        5000, "tipi_twin",  None,          None, 13),
        ...
        ("aspen",   "expired",            0, "tipi_twin",  None,          None, 9),
        ("indigo",  "complete",        5000, "tipi_twin",  "Vegetarian",  3, 8),
        ("wren",    "pending_payment",    0, "self_camping","Vegan",       None, 7),
        ("cedar",   "pending_payment",    0, "tipi_twin",  "Gluten-Free", None, 6),
        ...
        ("rowan",   "pending_payment",    0, "tipi_twin",  "Gluten-Free", None, 1),
    ...
    "e6": [
        ...
        ("willow",  "pending_payment", 0, "tipi_twin","Vegan",     None, 5),
        ("cedar",   "pending_payment", 0, "none",     "Gluten-Free",None, 4),
        ("sky",     "complete", 12500, "none",        None,         None, 3),
        ("sol",     "complete", 12500, "tipi_twin",  None,         None, 2),
    ...
    "e7": [
        ...
        ("devon",   "complete", 25000, "tipi_twin",  "Vegan",       None, 40),
        ...
        ("aspen",   "complete", 25000, "tipi_twin",  None,          None, 33),
        ...
        ("sol",     "complete", 25000, "tipi_twin",  None,          None, 20),
        ("sky",     "complete", 25000, "self_camping",None,          None, 18),
        ("wren",    "pending_payment", 0, "tipi_twin","Vegan",      None, 10),
        ("cedar",   "pending_payment", 0, "tipi_twin","Gluten-Free",None, 8),
    ...
    "e8": [
        ...
        ("indigo",  "complete", 45000, "tipi_twin",  "Vegetarian",  None, 40),
        ("lark",    "complete", 45000, "bell_tent",   None,          None, 38),
        ("willow",  "complete", 45000, "bell_tent",   "Vegan",       None, 35),
        ("sol",     "complete", 45000, "tipi_twin",  None,          None, 33),
        ("sky",     "complete", 45000, "self_camping",None,          None, 30),
        ("wren",    "pending_payment", 0, "bell_tent","Vegan",       None, 15),
        ("cedar",   "pending_payment", 0, "tipi_twin","Gluten-Free",None,10),
        ("rowan",   "expired",      0, "tipi_twin",  "Gluten-Free", None, 5),
    ],
    ...
    "e9": [
        ...
        ("aspen",   "complete", 27500, "tipi_twin",  None,          None, 48),
        ...
        ("sol",     "complete", 27500, "tipi_twin",  None,          None, 35),
        ("sky",     "complete", 27500, "self_camping",None,          None, 32),
        ("wren",    "pending_payment", 0, "bell_tent","Vegan",       None, 20),
        ("cedar",   "pending_payment", 0, "tipi_twin","Gluten-Free",None,15),
        ("rowan",   "pending_payment", 0, "tipi_twin","Gluten-Free",None, 10),
        ("devon",   "expired",      0, "tipi_twin",  "Vegan",       None, 5),
